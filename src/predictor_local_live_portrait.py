...
from .utils.crop import prepare_paste_back
...
class LivePortraitPipeline(object):
    ...
    def set_source_image(self, source_image):
        ...
        if inf_cfg.flag_do_crop:
            crop_info = self.cropper.crop_source_image(self.source_rgb_lst[0], crop_cfg)
        ...
        if inf_cfg.flag_pasteback and inf_cfg.flag_do_crop and inf_cfg.flag_stitching:
            mask_ori_float = prepare_paste_back(inf_cfg.mask_crop, crop_info['M_c2o'], dsize=(self.source_rgb_lst[0].shape[1], self.source_rgb_lst[0].shape[0]))
